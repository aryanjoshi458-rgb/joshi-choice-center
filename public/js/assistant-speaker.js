...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const AuraBrain = {
        keywords: {
            ...
            "delete": "Deleting data is a permanent action. In the Reports section, you can use the 'EDIT' or 'DELETE' buttons to manage individual transactions.",
            ...
            "software": "Joshi Choice Center is a total solution for shop transactions, digital services, and financial tracking. It's built with the premium Aura Design System and features the AURA & CYRUS Analytics Engine v4.0.",
            ...
            "new customer": "On the New Customer page, you can enter details for services. It features a premium 'Today's Report Summary' with high-fidelity action buttons and real-time calculation.",
            ...
            "aura & cyrus": "AURA & CYRUS is our Next-Gen Intelligence Engine. It powers the Analytics on the Customer Profile page and provides deep insights into business performance.",
            "cyrus": "Aura and Cyrus are the brains behind our analytics. You can see the 'AURA & CYRUS Analytics Engine v4.0' active in the Cyber Intelligence section.",
            "intelligence": "The Cyber Intelligence module provides a deep-dive analysis into your business data, featuring real-time tracking and professional visualization.",
            "cyber": "The Cyber Intelligence split-view in Settings shows our system's analytical core, featuring AURA & CYRUS v4.0 technology.",
            ...
            "pdf": "Our new Reports module features an Advanced PDF Preview! You can toggle between A4 Portrait and Landscape modes and view a professional table before saving.",
            "preview": "The PDF Preview modal is fully theme-aware and allows you to see exactly how your report will look before downloading or printing.",
            "orientation": "You can switch Report orientation! Use the 'Page Orientation' dropdown in the PDF Preview to choose between Landscape (Default) or Portrait.",
            "excel": "Need data in Excel? Every report can be exported as a professional .xlsx file with auto-sized columns and high-fidelity formatting.",
            ...
            "dark": "Dark mode is great for eyes! We've fixed all input fields and modals to look perfect in dark mode, including the new PDF Preview.",
            "light": "Our new Light Mode is crisp, high-contrast, and professional. We've eliminated all muddy shadows for a 'Premium HD' look.",
            ...
            "privacy shield": "The Privacy Shield is a premium security feature in Settings -> Security. It automatically blurs the screen when the window loses focus to keep your records safe.",
            "security": "Your privacy is our priority. We've added a 'Close Confirmation' system and 'Privacy Shield' to ensure your shop data remains protected.",
            ...
            "pending": "In Pending Payments, we use a modern GSAP-animated confirmation system to ensure you manage your dues effectively.",
            ...
            "logo": "Add your own branding! Upload your shop logo in Settings -> Shop Profile to see it on all thermal receipts and the PDF header.",
            ...
            "report": "Our new Reports design features blue-highlighted amounts, advanced PDF previews, and instant Excel exports.",
            ...
            "privacy": "We take privacy seriously. Your transaction data and customer profiles are stored locally using our secure Aura Shield technology.",
    ...
    const themeSlider = document.querySelector(".theme-toggle-switch .slider, .slider");
